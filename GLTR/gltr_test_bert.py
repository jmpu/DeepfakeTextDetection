...
def main():
	...
	parser.add_argument(
		'--bert_large_gltr_ckpt', # The GLTR-BERT model checkpoint for evaluation
		default=None,
		type=str,
		required=True,
		 )
	...
	loaded_model_test = pickle.load(open(args.bert_large_gltr_ckpt, 'rb'))
	...
	bert_large_cased_metrics = compute_metrics(y_preds_test,labels_test,labels_test, y_test_probs[:,1], args.bert_model)

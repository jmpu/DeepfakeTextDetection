...
def main():
	...
	print("Accuracy on gpt2-l on training set is : {}".format(acc))
	gpt2_xl_metrics = compute_metrics(y_preds_train,labels_train,labels_train, y_train_probs[:,1],args.gpt2_model)


	filename_train = args.gpt2_xl_gltr_ckpt
